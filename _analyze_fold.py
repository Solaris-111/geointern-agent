...
# Read prompt from file to avoid encoding issues
with open("d:/geointern-agent/_fold_prompt.txt", "r", encoding="utf-8") as f:
    prompt = f.read()
...
result = resp.json()
with open("d:/geointern-agent/_fold_result.json", "w", encoding="utf-8") as f:
