...
with open("d:/geointern-agent/output/fig2-1_v2_preview.png", "rb") as f:
    new_b64 = base64.b64encode(f.read()).decode()

with open("d:/geointern-agent/_compare_v2_prompt.txt", "r", encoding="utf-8") as f:
    prompt = f.read()
...
result = resp.json()
with open("d:/geointern-agent/output/compare_v2_result.json", "w", encoding="utf-8") as f:
